...
namespace LinkMe.Infrastructure.SqlServer.Migrations
{
    /// <inheritdoc />
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoryCommunity", x => new { x.CategoriesId, x.CommunitiesId });
                    table.ForeignKey(
                        name: "FK_CategoryCommunity_Categories_CategoriesId",
                        column: x => x.CategoriesId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CategoryCommunity_Communities_CommunitiesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CategoryCommunity_CommunitiesId",
                table: "CategoryCommunity",
